...
import SubscriberListWithSearch from "@/components/admin/subscribers/SubscriberListWithSearch";
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fb] dark:bg-[#0f1117]">
      ...
      <div className="pt-[88px] pb-10 px-4 sm:px-6 max-w-2xl mx-auto flex flex-col gap-3">
        ...
        <SubscriberListWithSearch initialTotal={total}>
