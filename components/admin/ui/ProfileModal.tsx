            ...
            {isEdit ? (
              <>
                ...
                <div className="flex flex-col gap-1.5 mb-4">
                  ...
                  <p className={`${inputClass} opacity-60 cursor-default select-all`}>
                    {profile?.email ?? "—"}
                  </p>
                </div>
              ...
              <>
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-xl border-2 border-gray-200 dark:border-gray-700 text-sm font-bold font-nunito text-[#374151] dark:text-gray-300 hover:border-gray-400 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-[#1e2a3a] transition-all cursor-pointer"
                >
                  Change password
                </button>
              </>
