...
const CALENDAR_CLASSES = {
  ...
  caption_label:   "relative z-10 text-sm font-bold text-[#0f1e3d] dark:text-gray-50",
  ...
  month_grid:      "w-full",
  weekdays:        "",
  weekday:         "text-center text-xs font-bold text-gray-400 dark:text-gray-500 py-2.5",
  weeks:           "",
  week:            "",
  day:             "text-center align-middle p-0.5 group",
  day_button: [
    "w-9 h-9 mx-auto rounded-full flex items-center justify-center",
    "text-sm font-semibold text-[#0f1e3d] dark:text-gray-200",
    ...
    "group-data-[today]:font-bold group-data-[today]:text-primary dark:group-data-[today]:text-[#93b8f0]",
...
const SEG =
  "w-12 text-center bg-transparent text-4xl font-bold text-[#0f1e3d] dark:text-gray-100 outline-none focus:bg-secondary dark:focus:bg-[#1e3a5f] rounded-xl py-1 caret-transparent tabular-nums transition-colors duration-150 select-none";
    ...
    <div className="flex flex-col items-center gap-3">
      ...
      >
        <input
          ...
          aria-label="Hours"
        />
        <span className="text-4xl font-bold text-primary dark:text-[#93b8f0] select-none leading-none pb-1 mx-0.5">:</span>
        <input
        ...
        <button
          ...
          className="w-14 text-center text-2xl font-bold text-primary dark:text-[#93b8f0] bg-transparent hover:bg-secondary dark:hover:bg-[#1e3a5f] active:scale-95 rounded-xl py-1 uppercase tracking-widest transition-all duration-150 cursor-pointer select-none flex-shrink-0"
        >
          {currentAmpm}
        </button>
      </div>
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-xs font-bold text-primary dark:text-[#93b8f0]">
          Pick a date
        </label>
      ...
      {scheduledLabel && (
        <div className="flex items-center gap-2.5 px-4 py-3 rounded-2xl bg-[#F0F5FF] dark:bg-[#1e2a3a] border-2 border-secondary dark:border-[#2a4a7a]">
          ...
          <p className="text-sm font-semibold text-[#0f1e3d] dark:text-gray-100">
